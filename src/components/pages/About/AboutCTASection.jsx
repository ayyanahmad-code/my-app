      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Join hands with APMS Engineering for reliable, innovative, and 
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">50+ experienced engineers</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <h4 className="text-white font-bold mb-1">Proven Track Record</h4>
                <p className="text-sm text-gray-300">500+ successful projects</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">ISO 9001:2015 certified</p>
              </div>
            </motion.div>
          </motion.div>
        </motion.div>
