...
<section className="py-10 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <Factory size={16} />
              <span className="text-sm font-semibold">INDUSTRIES SERVED</span>
            </motion.div>
            <motion.h2 
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Extensive experience across diverse industrial sectors
            </motion.p>
          </motion.div>
          ...
          >
            {industriesServed.map((industry, index) => (
              ...
              >
                ...
                <div className="mb-6">
                  <h4 className="font-semibold text-gray-700 mb-2">Product Examples:</h4>
                ...
                >
                  <h4 className="font-semibold text-blue-700 text-sm mb-1">Design Focus:</h4>
                  <p className="text-sm text-blue-600">{industry.focus}</p>
                </motion.div>
              </motion.div>
            ))}
          </motion.div>
