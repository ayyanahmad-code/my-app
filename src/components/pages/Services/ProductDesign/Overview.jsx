        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={slideInLeftVariants}>
              ...
              >
                <Sparkles size={16} />
                <span className="text-sm font-semibold">INNOVATION & CREATIVITY</span>
              </motion.div>
              <motion.h2 
              ...
              <motion.div className="space-y-4 text-lg text-gray-600" variants={containerVariants}>
                <motion.p variants={itemVariants}>
                  Our iterative design process validates design specifications at each stage of 
                  the life cycle. Innovation and creativity are the two vital needs of the 
                  industry, and we help companies by improving the aesthetic appeal of their products.
                </motion.p>
                <motion.p variants={itemVariants}>
                  In surface modeling, our product design team involves generating aesthetic 
                  features to improve the styling and appearance of products.
                </motion.p>
              </motion.div>
              ...
              <motion.div 
                ...
                whileHover="hover"
              >
                <h4 className="font-bold text-secondary-800 mb-4">Design Philosophy:</h4>
                <div className="space-y-3">
                  {[
                    { principle: 'User-Centric Approach', icon: '👤' },
                    { principle: 'Aesthetic Excellence', icon: '🎨' },
                    { principle: 'Functional Reliability', icon: '⚙️' },
                    { principle: 'Manufacturing Feasibility', icon: '🏭' },
                    { principle: 'Cost Optimization', icon: '💰' },
                    { principle: 'Sustainability Focus', icon: '🌱' }
                  ].map((item, index) => (
                    <motion.div 
                      key={index} 
                    ...
                    >
                      ...
                      <span className="text-gray-700">{item.principle}</span>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-white text-2xl font-bold">Design Cycle Components</h3>
              </div>
              <p className="mb-6">
                Our comprehensive design cycle ensures thorough development from initial 
                concept to final production release.
              </p>
              
              <div className="space-y-4">
                {[
                  { text: 'Concept Design & Selection', icon: '💡' },
                  { text: 'Preliminary Design with Material Selection', icon: '📋' },
                  { text: 'Detailed Module & Assembly Design', icon: '🔧' },
                  { text: 'Geometric Dimensioning & Optimization', icon: '📐' }
                ].map((item, index) => (
                  <motion.div 
                    key={index} 
