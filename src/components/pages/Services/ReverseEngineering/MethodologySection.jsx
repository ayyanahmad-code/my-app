        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Structured approach ensuring accuracy and quality at every step
            </motion.p>
          </motion.div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="space-y-3 mb-4">
                      <h4 className="font-semibold text-gray-700 text-sm">Key Activities:</h4>
                    ...
                    <motion.div 
                      ...
                      transition={{ duration: 0.2 }}
                    >
                      <h4 className="font-semibold text-primary-700 text-sm mb-1">Tools Used:</h4>
                      <p className="text-sm text-primary-600">{phase.tools.join(', ')}</p>
                    </motion.div>
                  </motion.div>
