  ...
  <section className="py-10 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <Play size={16} />
              <span className="text-sm font-semibold">DESIGN PROCESS</span>
            </motion.div>
            <motion.h2 
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Structured approach ensuring optimal fixture performance
            </motion.p>
          </motion.div>
          ...
          >
            ...
            <div className="hidden lg:block absolute left-1/2 top-24 transform -translate-x-1/2 h-1 bg-gray-300 w-full"></div>
