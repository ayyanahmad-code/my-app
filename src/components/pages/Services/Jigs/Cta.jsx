...
<section className="py-20 bg-gradient-to-r from-primary-600 to-accent-500 text-white">
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            >
              Need Jigs & Fixtures Design?
            </motion.h2>
            <motion.p 
              className="text-xl text-white/90 mb-8"
              variants={itemVariants}
            >
              Contact us for expert jig and fixture design services that increase 
              productivity, enhance quality, and reduce manufacturing costs.
            </motion.p>
