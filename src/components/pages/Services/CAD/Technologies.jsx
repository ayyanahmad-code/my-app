...
<section className="py-10 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <Chip size={16} />
              <span className="text-sm font-semibold">TECHNOLOGIES & TOOLS</span>
            </motion.div>
            <motion.h2 
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Advanced tools and platforms for building custom automation solutions
            </motion.p>
          </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold">Expert Automation Team</h3>
                </div>
                <p className="mb-6 text-white/90">
                  With 10+ years of experience in CAD customization and process automation, 
                  we deliver solutions that transform your engineering workflows, reduce 
              ...
              <div className="space-y-4">
                {[
                  { text: '10+ Years Automation Experience', icon: '📅' },
                  { text: 'CAD Software Expertise', icon: '📐' },
                  { text: 'Custom UI/UX Development', icon: '🎨' },
                  { text: 'End-to-End Automation', icon: '🔄' }
                ].map((item, index) => (
                  <motion.div 
                    key={index} 
